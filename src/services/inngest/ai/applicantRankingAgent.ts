...
// Applicant ranking powered by Gemini
// Note: Tenant isolation is enforced at application-level (see jobListingApplication.ts)
// Only job seekers within an organization's application pool can be ranked for that organization's listings
